...
joint_names_combset = joint_names_mirrored_human_19 + joint_names_common_Alphapose_n_Mirror[19:25] + ["head"]

joint_parents_combset = ['neck','pelvis','neck','right_shoulder',
                        'right_elbow','neck','left_shoulder', 'left_elbow', 
                        'pelvis','pelvis','right_hip', 'right_knee',
                        'pelvis','left_hip', 'left_knee', 'nose', 
                        'nose', 'right_eye', 'left_eye', 'left_heel',    
                        'left_heel', 'left_ankle', 'right_heel', 'right_heel',
                        'right_ankle', 'neck'
                        ]
...
joint_names_dcpose = [ "nose", "neck", "head", "unknown_joint_1", "pelvis", 
...
def  mirror19_to_mirror15_fn(h_pose):
    pose = h_pose[:, mirror19_to_mirror15, :]
    return pose
...
mirror19_to_mirror15 = [joint_names_mirrored_human_19.index(name) for name in joint_names_mirrored_human_15]
