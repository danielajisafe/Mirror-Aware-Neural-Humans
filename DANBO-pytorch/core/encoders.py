...
class BaseEncoder(nn.Module):
    ...
    def __init__(self, N_joints=26, N_dims=None, skel_type=SMPLSkeleton):
        super().__init__()
...
class RelDistEncoder(BaseEncoder):
    ...
    def __init__(self, N_joints=26, N_dims=1, skel_type=SMPLSkeleton):
...
class RelPosEncoder(BaseEncoder):
    ...
    def __init__(self, N_joints=26, N_dims=3, skel_type=SMPLSkeleton):
        super().__init__(N_joints, N_dims, skel_type=skel_type)
...
class PartRotateEncoder(BaseEncoder):
    def __init__(self, N_joints=26, N_dims=3, part_dims=10, skel_type=SMPLSkeleton):
